...
// Replace vscode-k9, Vscode K9 — See README.adoc for details., just run, Vscode K9 started successfully. with actuals
= vscode-k9 — Quick Start for Users
:toc:
:toclevels: 2

== What is vscode-k9?

Vscode K9 — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/vscode-k9.git
cd vscode-k9
just setup
----
...
[source,bash]
----
just install --portable --prefix=./vscode-k9-portable
----
...
[source]
----
Vscode K9 started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/vscode-k9/wiki
