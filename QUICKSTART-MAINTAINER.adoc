...
// Replace vscode-k9, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= vscode-k9 — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining vscode-k9 for
...
* Upstream: https://github.com/hyperpolymath/vscode-k9/issues
